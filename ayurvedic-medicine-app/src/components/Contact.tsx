            ...
            <div className="contact-methods">
              <div className="contact-method">
                ...
                <div className="contact-details">
                  ...
                  <p className="method-info">amolpowar222@gmail.com</p>
              ...
              <div className="contact-method">
                ...
                <div className="contact-details">
                  ...
                  <p className="method-info">+91 9321898247</p>
              ...
              <div className="contact-method">
                ...
                <div className="contact-details">
                  ...
                  <p className="method-info">Smt. Indira Gandhi College of Engineering, Ghansoli, Navi Mumbai</p>
